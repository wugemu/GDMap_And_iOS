...
- (void)initPolygons {
    ...
    CLLocationCoordinate2D tempPoints[4];
    tempPoints[0].latitude = coordinates[0].latitude - 0.02;
    tempPoints[0].longitude = coordinates[0].longitude + 0.02;
    
    tempPoints[1].latitude = coordinates[1].latitude - 0.02;
    tempPoints[1].longitude = coordinates[1].longitude - 0.02;
    
    tempPoints[2].latitude = coordinates[2].latitude + 0.02;
    tempPoints[2].longitude = coordinates[2].longitude - 0.02;
    
    tempPoints[3].latitude = coordinates[3].latitude + 0.02;
    tempPoints[3].longitude = coordinates[3].longitude + 0.02;
    polygon.hollowShapes = @[[MAPolygon polygonWithCoordinates:tempPoints count:4]];
