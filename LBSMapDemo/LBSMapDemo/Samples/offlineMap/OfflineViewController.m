...
- (void)detailAction
{
    MAOfflineMapViewController *offlineViewController = [MAOfflineMapViewController sharedInstance];
    [self.navigationController pushViewController:offlineViewController animated:YES];
}
